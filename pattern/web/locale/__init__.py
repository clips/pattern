...
### GEOCODE ###########################################################################################
# capital => (latitude, longitude, ISO-639 language code)
      ...
      u'Kuala Lumpur': (  3.167, 101.700, "ms"),
       u'Kuwait City': ( 29.367,  47.967, "ar"),
         ...
         u'Ljubljana': ( 46.050,  14.517, "sl"),
            ...
            u'Lusaka': (-15.417,  28.283, "en"),
        u'Luxembourg': ( 49.600,   6.117, "cd"),
            u'Madrid': ( 40.400,  -3.683, "es"),
           u'Managua': ( 12.150, -86.283, "es"),
            u'Manila': ( 14.583, 121.000, "tl"),
...
def geocode(location):
    """ Returns a (latitude, longitude, language code)-tuple for the given capital.
    """
