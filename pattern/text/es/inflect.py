...
verb_irregular_inflections = [
    (u"yéramos", "ir"), ("cisteis",
                         "cer"), ("tuviera", "tener"), ("ndieron", "nder"),
    ("ndiendo", "nder"), (u"tándose",
                          "tarse"), ("ndieran", "nder"), ("ndieras", "nder"),
    (u"izaréis", "izar"), ("disteis",
                           "der"), ("irtiera", "ertir"), ("pusiera", "poner"),
    ("endiste", "ender"), ("laremos",
                           "lar"), (u"ndíamos", "nder"), (u"icaréis", "icar"),
    (u"dábamos", "dar"), ("intiera",
                          "entir"), ("iquemos", "icar"), (u"jéramos", "cir"),
    ("dierais", "der"), ("endiera",
                         "ender"), (u"iéndose", "erse"), ("jisteis", "cir"),
    ("cierais", "cer"), (u"ecíamos",
                         "ecer"), (u"áramos", "ar"), (u"ríamos", "r"),
...
class Verbs(_Verbs):
    ...
    def find_lemma(self, verb):
        ...
        for x in ((
                ...
                u"ando", u"ado", u"ad",
                # future
                u"aré", u"arás", u"ará", u"aremos", u"aréis", u"arán",
                # conditional
                u"aría", u"arías", u"aríamos", u"aríais", u"arían",
                # past imperfective
                u"aba", u"abas", u"ábamos", u"abais", u"aban",
                # past perfective
                u"é", u"aste", u"ó", u"asteis", u"aron",
        ...
        for x in ((
                ...
                u"iendo", u"ido", u"ed",
                # future
                u"eré", u"erás", u"erá", u"eremos", u"eréis", u"erán",
                # conditional
                u"ería", u"erías", u"eríamos", u"eríais", u"erían",
                # past imperfective
                u"ía", u"ías", u"íamos", u"íais", u"ían",
                # past perfective
                u"í", "iste", u"ió", "imos", "isteis", "ieron",
        ...
        for x in ((
                # future
                u"iré", u"irás", u"irá", u"iremos", u"iréis", u"irán",
    ...
    def find_lexeme(self, verb):
        ...
        if v.endswith("ar") or not v.endswith(("er", "ir")):
            ...
            return [v,
                    b + u"o", b + u"as", b + u"a", b +
                        u"amos", b + u"áis", b + u"an", b + u"ando",
                    b + u"é", b + u"aste", b + u"ó", b + u"amos", b +
                        u"asteis", b + u"aron", b + u"ado",
                    b + u"aba", b + u"abas", b + u"aba", b +
                        u"ábamos", b + u"abais", b + u"aban",
                    v + u"é", v + u"ás", v + u"á", v +
                        u"emos", v + u"éis", v + u"án",
                    v + u"ía", v + u"ías", v + u"ía", v +
                        u"íamos", v + u"íais", v + u"ían",
                    b + u"a", v[:-1] + "d",
                    b + u"e", b + u"es", b + u"e", b +
                        u"emos", b + u"éis", b + u"en",
            ...
            return [v,
                    b + u"o", b + u"es", b + u"e", b + p1 +
                        u"mos", b + p2 + u"is", b + u"en", b + u"iendo",
                    b + u"í", b + u"iste", b + u"ió", b + u"imos", b +
                        u"isteis", b + u"ieron", b + u"ido",
                    b + u"ía", b + u"ías", b + u"ía", b +
                        u"íamos", b + u"íais", b + u"ían",
                    v + u"é", v + u"ás", v + u"á", v +
                        u"emos", v + u"éis", v + u"án",
                    v + u"ía", v + u"ías", v + u"ía", v +
                        u"íamos", v + u"íais", v + u"ían",
                    b + u"a", v[:-1] + "d",
                    b + u"a", b + u"as", b + u"a", b +
                        u"amos", b + u"áis", b + u"an",
